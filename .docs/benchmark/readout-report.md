...
| 인증 프로파일 (총 Pod 수)  | 1 Pod당 CPU Request | 1 Pod당 Memory Request          | 여유(30%) 반영 1 Pod당 CPU | 여유(30%) 반영 1 Pod당 Memory       |
| ------------------ | ------------------ | ------------------------------ | --------------------- | ------------------------------ |
| HS256 전용 (8 Pods)  | 2.0 vCPU           | 0.45 ~ 0.70 GiB (460~716 MiB)  | 2.6 vCPU              | 0.59 ~ 0.91 GiB (604~931 MiB)  |
| 혼합 50:50 (10 Pods) | 2.5 vCPU           | 0.55 ~ 0.85 GiB (563~870 MiB)  | 3.25 vCPU             | 0.72 ~ 1.11 GiB (737~1136 MiB) |
| RS256 전용 (12 Pods) | 3.0 vCPU           | 0.65 ~ 1.00 GiB (665~1024 MiB) | 3.9 vCPU              | 0.84 ~ 1.30 GiB (860~1331 MiB) |
...
### 6.4 pod 1대 단위 용량
| 인증 프로파일 | 1 Pod CPU request | 1 Pod Memory request | 1 Pod 여유(30%) 반영 CPU | 1 Pod 여유(30%) 반영 Memory |
|---|---:|---:|---:|---:|
| HS256 전용 (8 Pods) | 2.0 vCPU | 0.45 ~ 0.70 GiB (460~716 MiB) | 2.6 vCPU | 0.59 ~ 0.91 GiB (604~931 MiB |
| 혼합 50:50 (10 Pods) | 2.5 vCPU | 0.55 ~ 0.85 GiB (563~870 MiB) | 3.25 vCPU | 0.72 ~ 1.11 GiB (737~1136 MiB) |
| RS256 전용 (12 Pods) | 3.0 vCPU | 0.65 ~ 1.00 GiB (665~1024 MiB) | 3.9 vCPU | 0.84 ~ 1.30 GiB (860~1331 MiB) |
...
| 운영 모드 | 권장 워커 노드 | 비고 |
|---|---:|---:|
| HS256 전용 | 4~5 nodes | 노드당 최대 Pod 2대 배치 기준 (HA 고려) |
| 혼합(50:50) | 5 nodes | 노드당 최대 Pod 2대 배치 기준 |
| RS256 전용 | 7 nodes | 노드당 최대 Pod 2대 배치 기준 (N+1 예비 노드 포함) |
